    ...
    public function definitions(): array
    {
        return [
            'home' => [
                ...
                'route_name' => 'home',
                'seo' => [
                    'title' => 'VALORANT Rank Boosting | Fast, Safe VALORANT Boost',
                    'description' => 'Get fast, safe VALORANT rank boosting with Solo and Duo / Self-Play options, live tracking, and clear pricing.',
                    'canonical' => null,
                    'robots' => 'index,follow',
                    'type' => 'website',
                ...
                'content' => [
                    'hero' => [
                        'eyebrow' => 'VALORANT RANK BOOSTING',
                        'headline' => 'Fast, Safe VALORANT Rank Boosting Built Around Your Goal.',
                        'description' => 'Configure a VALORANT boost with Solo or Duo / Self-Play options, fair pricing, verified boosters, and live order tracking from start to finish.',
                        'primary_cta_label' => 'Start My VALORANT Boost',
                        'primary_cta_url' => '/#servicesTab',
                        'secondary_cta_label' => 'Become a Booster',
                        'secondary_cta_url' => '/become-booster',
                        'trust_bullets' => [
                    ...
                    'how_it_works' => [
                        'title' => 'How Your VALORANT Boost Works',
                        'steps' => [
                            [
                    ...
                    'latest_blogs' => [
                        'title' => 'VALORANT Boosting Guides',
                        'description' => 'Fresh guides on VALORANT rank boosting, Duo / Self-Play choices, pricing factors, safety, and smarter ways to climb.',
                        'button_label' => 'Read VALORANT Guides',
                    ],
                ],
                'sections' => [
                    [
